...
PlotVelCustom=0
VelCustomFile=$root/h5data/test_zoomout.vtk
...
############################# zoom #############################
jobName=bhdisk_transition_full-to-superzoom-2
h5folder=3d_data_26_01_04_060839
idx=0
totframes=200
pyscript=run.py
...
view2XML=$attsdir/bhdisk_view_30deg_superzoomin.xml
...
############################# fly_around #############################
jobName=vel_fly_around
h5folder=3d_data_25_08_03_014635
idx=17
totframes=100
pyscript=run.py
