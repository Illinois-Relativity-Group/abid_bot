...
is_tilted=1 #1 for tilted case in bhdisk
...
def make_seed_file(coord,ahtype='1'):
...
for coord in coordList:
        #make_seed_file(coord,ahtype='1')
        #make_seed_file(coord,ahtype='2')
        make_seed_file(coord,ahtype=ahtype)