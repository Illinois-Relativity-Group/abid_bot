...
def setAnnotations(lightlist=[]):#sets background, sets up text
        ...
        Ann.legendInfoFlag = 0 # 0/1 to turn off/on colorbar
        Ann.databaseInfoFlag = 0
        Ann.userInfoFlag = 0
        Ann.axes3D.visible = 0
        Ann.axes3D.triadFlag = 0
        Ann.axes3D.bboxFlag = 0 # 1 or 0
...
def PlotBox():
        ...
        file_path = "/scratch2/10281/guoyuheng/bh_disk_sol_32/h5data/box.3d" #"/anvil/scratch/x-colson1/abid_bot_sol_01_v2/h5data/cube_edges.3d"
...
#                               DefineScalarExpression("logbsq2r", "log10(<fac>*<bsq2r>)")
        ...
        def SetAnnotations(self, bgcolor='blue', lightlist=[]):
                ...
                Ann.axes3D.visible = 0
                Ann.axes3D.triadFlag = 0
                Ann.axes3D.bboxFlag = 0 # one or zero
                SetAnnotationAttributes(Ann)
...
#############################################
        ...
        def SetPlots(self):
                ...
                if plot_box:                          PlotBox() # plot shape function
#############################################
...
#                            pass
                ...
                if self.spinvec():
                        ...
                        #boxspinvec(5.47428056e-02, -2.27912712e-18,  5.47428056e-02, forceAddOp or frame==self.firstFrame) #use this for first frame
                        #print('custom start point of spinvec at: 5.47428056e-02 -2.27912712e-18  5.47428056e-02') #use this for first frame
                        print("spinvec set")
                        #if self.cutPlot: box(self.CoM_y, forceAddOp or frame==self.firstFrame)
                if self.g00():
