...
x1, y1, x2, y2 = 0.0000000000E+000,   0.0000000000E+000,   1.2500168541E+001,   0.0000000000E+000
r1, h1, r2, h2, r3, h3 = 10, 1, 0.6, 2, 1.4, 2
num_per = 8
ref_z = True

centers = [(x1, y1, 0)] # (x, y, z) list of centers
pairs = [(r1, h1), (r1, h1), ] # (radius, height) you can have as many pairs as you want
num_seeds_per_ring = [num_per, num_per] # list containing number of seeds per ring. Must be same len as num of pairs
