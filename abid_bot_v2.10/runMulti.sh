...
lastFolder=10           #      folder numbers are 1-indexed, so starts at 1
framesPerRun=10        
...
PlotSpinPlane=1 # plot plane perpendicular to spin vector
