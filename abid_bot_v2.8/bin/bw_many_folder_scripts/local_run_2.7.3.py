...
PlotDensAsVol	= sys.argv[6] ==  '1' # Plot density in a volume plot
PlotDensAsIso	= sys.argv[7] ==  '1' # Plot density in a pseudocolor plot as isosurfaces
PlotDensLinear	= sys.argv[8] ==  '1' # Plot linear scale density rather than log scale
PlotVel  		= sys.argv[9] ==  '1' # Plot velocity arrows
PlotBsq2r		= sys.argv[10] ==  '1' # Plot B squared over 2 rho
Plotg00  		= sys.argv[11] ==  '1' # Plot g00 from metric
refPlot			= sys.argv[12] ==  '1' # Reflect plot over xy plane
cutPlot  		= sys.argv[13] ==  '1' # only show back half (y>0), needs view like: (0,-x,y)

########## EXPERIMENTAL ##########
PlotEvolve 		= sys.argv[14] ==  '1'
PlotZoom 		= sys.argv[15] ==  '1'
PlotFlyOver 	= sys.argv[16] ==  '1'
PlotFlyAround 	= sys.argv[17] ==  '1'
##################################
...
print(sys.argv)
h5dir 			= sys.argv[18]
extrasDir 		= sys.argv[19]
saveFolder 		= sys.argv[20]
rank 			= int(sys.argv[21])
total_ranks 	= int(sys.argv[22])
numBfieldPlots	= int(sys.argv[23])
vectorXML 		= sys.argv[24]
bsq2rXML 		= sys.argv[25]
max_density 	= sys.argv[26]
rho_pseudoXML 	= sys.argv[27]
rho_isoXML 		= sys.argv[28]
g00_pseudoXML 	= sys.argv[29]
g00_isoXML 		= sys.argv[30]
