...
centers = [(-12.8, -0.2, 0), (12.8, 0.2, 0), (-12.8, -0.2, 0), (12.8, 0.2, 0)] # (x, y, z) list of centers
pairs = [(0.34, 1), (0.34, 1), (2.25, 1), (2.25, 1)] # (radius, height) you can have as many pairs as you want
num_seeds_per_ring = [8, 8, 8, 8] # list containing number of seeds per ring. Must be same len as num of pairs
