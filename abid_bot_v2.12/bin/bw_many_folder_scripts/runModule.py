...
class VisitPlot:
        ...
        def __init__(self, plot_opts, arg_list):
                ...
                self.PlotShapeCustom,           # Plot shape with custom .3d database
...
#                               DefineScalarExpression("logbsq2r", "log10(<fac>*<bsq2r>)")
               ...
               #                    "((<Bx>*<vx>+<By>*<vy>+<Bz>*<vz>)/(sqrt(<vx>*<vx>+<vy>*<vy>+<vz>*<vz>)*sqrt(<Bx>*<Bx>+<By>*<By>+<Bz>*<Bz>)))))))))")
                ...
                if self.gw3D():
                        ...
                        #DefineScalarExpression("modifiedwave", "<GW-FIELD>")
                        print("modifiedwave Loaded")
                        #OpenDatabase("/anvil/scratch/x-rnarasimhan/abid_bot_gw/box.3d")
...
#                            pass
                ...
                if self.PlotShapeCustom:
                        OpenDatabase(self.ShapeCustomFile)
                        AddPlot('Pseudocolor', 'test')
                        p = PseudocolorAttributes()
                        #p.pointSize = 0.20
                        #p.pointColor = (150, 20, 20, 255)
                        p.colorTableName = "white"
                        #p.opacity = 0.5
                        SetPlotOptions(p)
                        DrawPlots()
                        #print(p)
                ...
                if self.PlotGW3D:
                        ...
                        LoadAttribute(self.gw3D_volXML, vol2) #/anvil/scratch/x-rnarasimhan/abid_bot_gw/bin/bw_many_folder_scripts/atts/gw_nsns_2024.xml
                        #LoadAttribute("/anvil/scratch/x-rnarasimhan/abid_bot_gw/bin/bw_many_folder_scripts/atts/gw_linear_op.xml" , vol2)
                        SetPlotOptions(vol2)
                        
                        
                        #gw3Dplots = (self.idx("gw3D"), self.idx("gw3Dbox"))
                        #SetActivePlots(gw3Dplots)



                        SetActivePlots(self.idx("gw3D"))
                        # AddOperator("Clip")
                        # ClipAtts = ClipAttributes()
                        # ClipAtts.funcType = ClipAtts.Sphere
                        # ClipAtts.radius = 75
