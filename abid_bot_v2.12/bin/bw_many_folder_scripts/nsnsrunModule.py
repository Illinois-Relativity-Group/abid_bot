...
def cylinder_velocity(addOp):
        ...
        CylAtts.point1=(0, 0, -100)
        CylAtts.point2=(0, 0, 100)
        CylAtts.radius=50
        CylAtts.inverse=0
...
class VisitPlot:
        ...
        def __init__(self, plot_opts, arg_list):
                ...
                self.h5dir, self.extrasDir, self.saveFolder, self.rank, self.total_ranks, self.numBfieldPlots, self.vector1XML, self.vector2XML, self.spinvecXML ,self.bsq2rXML, self.bsq2r_pseudoXML, self.bsq2r_isoXML, self.max_density, self.rho_pseudoXML, self.rho_isoXML, self.g00_pseudoXML, self.g00_isoXML, = self.arg_list
        ...
        def __repr__(self):
                ...
                args = ['h5dir', 'extrasDir', 'saveFolder', 'rank', 'total ranks', 'numBfieldPlots', 'vectorXML','spinvecXML', 'bsq2rXML', 'bsq2r_pseudoXML', 'bsq2r_isoXML', 'max_density', 'rho_pseudoXML', 'rho_isoXML', 'g00_pseudoXML', 'g00_isoXML']
...
#############################################
        ...
        def LoadDatabases(self):
                ...
                if self.bsq2r() or self.bsq2r_iso():
                        ...
                        LoadandDefine(self.smallb2dir, "smallb2")
                        DefineScalarExpression("logbsq2r","log10(<smallb2>/(2*<rho_b>), -200)")
                        #DefineScalarExpression("logbsq2r","log10(<smallb2>/0.000000044100785587, -200)")
