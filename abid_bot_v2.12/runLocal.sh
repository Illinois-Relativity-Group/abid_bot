...
PlotVelCustom=0  #plot velocity arrows with custom generated .vtk file using Vel.xml settings
VelCustomFile=$root/h5data/test.vtk
#VelCustomFile=$root/h5data/half_c_field.vtk

PlotShapeCustom=1
ShapeCustomFile=$root/h5data/box.3d   #make sure 4th column is named 'test' and .3d file is in h5data
