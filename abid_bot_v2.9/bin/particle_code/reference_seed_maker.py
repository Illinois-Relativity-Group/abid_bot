...
centers = [(0.0, 0.0, 0.0)] # (x, y, z) list of centers
pairs = [(1.0, 1.0)] # (radius, height) you can have as many pairs as you want
num_seeds_per_ring = [8] # list containing number of seeds per ring. Must be same len as num of pairs
