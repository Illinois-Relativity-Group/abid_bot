...
rank = 0
total_ranks = 100
saveDir = "/u/sciteam/skhan/scratch/NSNS2/nsns_extras/bw_many_folder_scripts/misc_codes/movies/"
root_dir = "/u/sciteam/skhan/scratch/NSNS2/"
h5_folder = "3d_data_201510281105/" 
idx = 0
tot_frames = 100
...
particleXML = root_dir + 'nsns_extras/bw_many_folder_scripts/misc_codes/particles.xml'
particleTXT = root_dir + 'nsns_extras/bw_many_folder_scripts/misc_codes/bhseed_beg.txt'
...
print LoadAttribute(beg_volume_xml, vol1), LoadAttribute(end_volume_xml, vol2)
print LoadAttribute(particleXML, stream_particles)
...
print SetActivePlots(1)

file1 = open(particleTXT,'r')
