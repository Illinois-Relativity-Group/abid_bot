...
r1, h1, r2, h2, r3, h3 = 3, 1, 0.6, 2, 1.4, 2
num_per = 8
ref_z = False

centers = [(x1, y1, 0), (x2, y2, 0), (x1, y1, 0), (x2, y2, 0), (x1, y1, 0), (x2, y2, 0)] # (x, y, z) list of centers
pairs = [(r1, h1), (r1, h1), (r2, h2), (r2, h2), (r3, h3), (r3, h3)] # (radius, height) you can have as many pairs as you want
num_seeds_per_ring = [num_per, num_per, num_per, num_per, num_per, num_per] # list containing number of seeds per ring. Must be same len as num of pairs
