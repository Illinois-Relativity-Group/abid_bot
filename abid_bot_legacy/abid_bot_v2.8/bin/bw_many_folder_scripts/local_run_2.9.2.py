...
PlotDensAsVol	= sys.argv[3] ==  '1' # Plot density in a volume plot
PlotDensAsIso	= sys.argv[4] ==  '1' # Plot density in a pseudocolor plot as isosurfaces
PlotDensLinear	= sys.argv[5] ==  '1' # Plot linear scale density rather than log scale
PlotVel  		= sys.argv[6] ==  '1' # Plot velocity arrows
PlotBsq2r		= sys.argv[7] ==  '1' # Plot B squared over 2 rho
Plotg00  		= sys.argv[8] ==  '1' # Plot g00 from metric
refPlot			= sys.argv[9] ==  '1' # Reflect plot over xy plane
cutPlot  		= sys.argv[10] ==  '1' # only show back half (y>0), needs view like: (0,-x,y)

########## EXPERIMENTAL ##########
PlotEvolve 		= sys.argv[11] ==  '1'
PlotZoom 		= sys.argv[12] ==  '1'
PlotFlyOver 	= sys.argv[13] ==  '1'
PlotFlyAround 	= sys.argv[14] ==  '1'
##################################
...
print(sys.argv)
h5dir 			= sys.argv[15]
extrasDir 		= sys.argv[16]
saveFolder 		= sys.argv[17]
rank 			= int(sys.argv[18])
total_ranks 	= int(sys.argv[19])
numBfieldPlots	= int(sys.argv[20])
vectorXML 		= sys.argv[21]
bsq2rXML 		= sys.argv[22]
max_density 	= sys.argv[23]
rho_pseudoXML 	= sys.argv[24]
rho_isoXML 		= sys.argv[25]
g00_pseudoXML 	= sys.argv[26]
g00_isoXML 		= sys.argv[27]
...
if PlotZoom or PlotFlyOver or PlotFlyAround:
	idx = int(sys.argv[28])
	num_frames = int(sys.argv[29])
	view_initial = sys.argv[30]
	vol_initial = sys.argv[31]
	miscatts = [idx, num_frames, view_initial, vol_initial]
	if PlotZoom:
		view_final = sys.argv[32]
		vol_final = sys.argv[33]
