...
root = "/scratch1/07525/tg868241/bhdisk_45/" 
h5dir = root+"h5data/"		#with / at the end
iters_txt = root+"particle_tracer/iters.txt" 
seedfile = root+"particle_tracer/seeds_trace.txt"
savefile = root+"particle_tracer/ptc_tracer.txt"
rl = range(13)
MPI = 128
dt= 0.11265
