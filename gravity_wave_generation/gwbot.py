...
class GWBot:
    def __init__(self, params_gw):
        ...
        self.unpack_memorySettings(params_gw[5])
    ...
    def unpack_testGWSettings(self, testGWSettings):
        self.test_num_times, self.test_dt, self.test_kind, \
            ...
            = testGWSettings
    def unpack_memorySettings(self, memorySettings):
        self.memory_modes, self.memory_files, self.rhphc_file, self.plot_memory_effect \
            = memorySettings
