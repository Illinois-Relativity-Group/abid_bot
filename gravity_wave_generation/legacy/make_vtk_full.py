...
def write_vtk_2D(ylm, r, t, dt, clm, xs, ys, sx, sy, fol, all_modes, modes, r_areal, num_times, dmemory, clm20, clm40, ylm20, ylm40, gw_root, plot_memory_effect):
    ...
    scale_factor = 5000 #15000 #20000 #30000  #to scale the plane so it doesn't look flat (default 5000). Lowered 15000->5000 for 15x zoom (waves were too big).
...
if __name__ == '__main__':
    with closing(Pool(processes=128)) as pool:
