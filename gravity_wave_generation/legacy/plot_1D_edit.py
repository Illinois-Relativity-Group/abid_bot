...
output_dir = '/anvil/scratch/x-yguo11/blender_gw_dev/frames_1D'
...
hp = np.loadtxt("/anvil/scratch/x-yguo11/abid_bot_dev/gravity_wave_generation/VTKdata/clm_sum_vs_tret_pos.dat")  # sol_05, already cropped to t_ret>=0
x = hp[:, 0] # Time
y = hp[:, 1]  # h_+ values
...
# Generate frames
for i in range((num_times + 1) // 2):   # cover all cropped rows at the script's 2-pts/frame cadence
