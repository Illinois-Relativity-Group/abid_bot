"""regen_1d_plots.py -- regenerate the sol_05 1D strain plots cropped to retarded time u >= 0.

The rhphc.8.dat time column is retarded time u = t_coord - r_* (spans -r_* .. T_end-r_*).
...
Standalone (no gwbot import) to avoid the params_gw import-race. Writes NEW files (keeps the
old negative-time plots as traces).
"""
import numpy as np
import matplotlib.pyplot as plt

ROOT     = "/anvil/scratch/x-yguo11/abid_bot_dev/gravity_wave_generation"
RHPHC    = f"{ROOT}/psi4_dir/rhphc.8.dat"
