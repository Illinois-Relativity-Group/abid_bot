...
# # # START PARAMETERS FOR MEMORY EFFECT # # #
plot_memory_effect = False  #boolean 0 (false) or 1 (true) to plot memory effect
memory_modes = [20, 40] # lm modes to include in memory effect calculation (l,m)
...
r_areal = 600   #extraction radius:  r_areal column in Psi4_file
gw_dt = 1.2     #dt in Psi4 file, not same as dt in regular params, is set automatically after
num_modes = 21 #77   #is num columns of Psi4 - 5 divided by 2, printed out by calc_clm
num_times = 1610 #num rows in Psi4, is changed automatically after, printed out by calc_clm as well
...
memorySettings = [memory_modes, memory_files, rhphc_file, plot_memory_effect]

params_gw = [generalGWSettings, psi4Settings, gridSettings, simulationSettings, testGWSettings, memorySettings]
print(params_gw)
